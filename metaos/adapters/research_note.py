...
def material_from_source(source: Dict[str, Any]) -> Dict[str, Any]:
    return {
        "material_id": str(source.get("material_id") or "research:unknown"),
        ...
        "domain": str(source.get("domain") or "research"),
...
def artifact_from_output(output: Dict[str, Any]) -> Dict[str, Any]:
    return {
        "artifact_id": str(output.get("artifact_id") or "research-artifact:unknown"),
        ...
        "metadata": {"citation_count": int(output.get("citation_count", 0) or 0)},
    }
