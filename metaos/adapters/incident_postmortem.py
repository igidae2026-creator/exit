...
def adapter_manifest() -> Dict[str, Any]:
    return {
        "adapter_name": "incident_postmortem",
...
def material_from_source(source: Dict[str, Any]) -> Dict[str, Any]:
    return {
        "material_id": str(source.get("material_id") or "incident_postmortem:source"),
        ...
        "metadata": {"project_type": "incident_postmortem"},
    }


def artifact_from_output(output: Dict[str, Any]) -> Dict[str, Any]:
    return {
        "artifact_id": str(output.get("artifact_id") or "incident_postmortem:artifact"),
        ...
        "artifact_type": "incident_postmortem",
        "metadata": {"project_type": "incident_postmortem"},
    }
